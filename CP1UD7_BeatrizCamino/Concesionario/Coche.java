...
public abstract class Coche {
	...
	//este método ayuda a registrar de forma interactiva los datos básicos de la superclase.
	
	public void registroCoche(Scanner sc) {
        setMatricula(pedirCadenaNoVacia(sc, "Introduce la matrícula:"));
        setModelo(pedirCadenaNoVacia(sc, "Introduce el modelo:"));
        setColor(pedirCadenaNoVacia(sc, "Introduce el color:"));
        setKms(pedirEntero(sc, "Introduce los kilómetros:"));
        setPrecio(pedirDecimal(sc, "Introduce el precio:"));
    }

	//usamos protected para que las clases hijas puedan tener acceso a estos métodos.
	...
	public abstract void registrar(Scanner Sc);
}
